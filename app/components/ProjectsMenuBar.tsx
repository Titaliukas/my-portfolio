...
export default function ProjectsMenuBar({
	...
	return (
		<div ref={barRef} className='relative flex h-[22px] items-center bg-[#EDEDED] text-[13px]'>
			{menus.map((menu) => (
				<div key={menu.label} className='relative'>
					<button
						className={`px-4 py-0.5 text-black ${
			...
			<div className='px-4 py-[2px] text-black opacity-30'>Help</div>
